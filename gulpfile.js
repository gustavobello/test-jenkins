...
// //INIT
// process.env.JUNIT_REPORT_PATH = 'test/result/test-results.xml';
// process.env.JUNIT_REPORT_STACK = 1;

// // Unit Test
// gulp.task('unit-server', function () {
//     return gulp.src(['./test/unit/server/*.js'])
...
//         console.log('missing parameter. use --version xxx');
//         return;
//     }
